...
| 5 | Wix UX Writing Glossary cross-check on `Nested Repeater`, `Outer Repeater`, `Parent item`, `Child item`, `This item` | Manual check via the Glossary API (VPN required) |
...
| 7 | Jira UPI / EDITOR / CMS / STUDIO scrape for prior tickets — Jira auth was unavailable during discovery | Re-run after Jira auth restored |
